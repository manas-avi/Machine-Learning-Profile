...
% J due to regularisation

% reuse the cost function with matrix of results
J = 1 / m * sum(sum((-Y .* log(A3) - (1 - Y) .* log(1 - A3)))) + Jreg;
% this is the final value of J


% just apply the formulas to get the final answer

% step 2
delta3 = A3 - Y;      
% only the last one will be this simple becasue
% that is what is directly used by the defination
% step 3
...
grad = [Theta1_grad(:) ; Theta2_grad(:)];
 % so that they can be used as vectors by the sfinmuncg algorithm
